public class NumDLNode {
     ...
     */
    private NumDLNode next;

    /**
     * A pointer to the previous node of the list.
     */
    private NumDLNode previous;
     ...
     */
    public NumDLNode(double element, NumDLNode previous, NumDLNode next) {
     ...
     */
    public void setNext(NumDLNode node) {
        next = node;
    }
     ...
     */
    public void setPrevious(NumDLNode node) {
        previous = node;
    }
}
